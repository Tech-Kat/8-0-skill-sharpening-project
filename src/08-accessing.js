...
function getFlatObject(person) {
  let object = {...person.names, ...person.address, numbers:person.numbers};
  return object
} 
//  numbers:person.numbers - is used to access the key numbers thn it accesses the values within that key (numbers)
